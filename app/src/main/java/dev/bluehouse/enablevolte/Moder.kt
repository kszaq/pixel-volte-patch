...
class SubscriptionModer(val subscriptionId: Int) : Moder() {
    ...
    val voLTEProvisioningRequired: Boolean
        get() = this.getBooleanValue(CarrierConfigManager.KEY_CARRIER_VOLTE_PROVISIONING_REQUIRED_BOOL)
    ...
    val blockIPV6OnlyWifi: Boolean
        get() = this.getBooleanValue("qns.block_ipv6_only_wifi_bool")
